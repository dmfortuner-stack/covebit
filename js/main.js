...
function initBookingEngine() {
  ...
  function sendBookingConfirmationEmails(booking) {
    ...
    const emailBody = [
      ...
      'Trader Details    : D. Meena trading as Covebit (Wembley, London)',
      'Terms & Conditions: https://covebit.co.uk/terms.html',
      '',
      '--------------------------------------------------',
      'BOOKING TERMS SUMMARY',
      '--------------------------------------------------',
      '• Service Delivery: Remote IT Support (Quick Assist / AnyDesk)',
      '• Cancellation    : Full refund if cancelled 2+ hours prior to session.',
      '• Late Cancel Fee : £25 fee if cancelled within 2 hours of appointment.',
      '• Consumer Rights : 14-day statutory cooling-off under CCR 2013.',
      '• No-Fix No-Fee   : If issue cannot be diagnosed or resolved, you owe nothing.',
      '• Full Legal Terms: https://covebit.co.uk/terms.html',
      '',
      '--------------------------------------------------',
  ...
  form.addEventListener('submit', async (e) => {
    ...
    const orderDetails = [
      ...
      'Trader: D. Meena trading as Covebit | Wembley, London | +44 7979 515140',
      'Terms & Conditions: https://covebit.co.uk/terms.html',
      'Booking Terms Summary: Full refund if cancelled 2+ hrs prior; £25 late fee within 2 hrs.',
      'Immediate-Start Confirmation: I request that work starts before the 14-day cooling-off period ends. I understand that once the session starts, the booked fee is payable as set out in the Covebit Terms and Conditions.',
      '',
      'Issue Description:',
      issue
    ].filter(Boolean).join('\n');
